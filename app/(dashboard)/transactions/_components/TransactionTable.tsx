...
const columns: ColumnDef<TransactionHistoryRow>[] = [
...

  {
    ...
    cell: ({ row }) => (
      <div
        className={cn(
          "capitalize rounded-lg text-left p-2",
...
function TransactionTable({ from, to }: Props) {
  ...
  return (
    <div className="w-full">
      <div className="flex flex-wrap items-end justify-between gap-2 p-9">
      ...
      <SkeletonWrapper isLoading={history.isFetching}>
        ...
        <div className="flex items-center justify-end space-x-2 p-8">
          <Button
            variant="outline"
            size="sm"
